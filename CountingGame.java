...
public class CountingGame
{
    ...
    public static void main(String args[])
    {
        ...
        rhyme = getRhyme();
       // System.out.println("The rhyme list is " + rhyme );
   ...
   public static int doRhyme(ListInterface<Integer> players, ListInterface<String> rhyme, int startAt)
    {
       ...
       int  l=0;
        while(l<k)
        {
    	   ...
    	   if(i>j)
       		i=1;
        	System.out.println( players.getEntry(i)+"sings :"+rhyme.getEntry(l));	      	
        }
    	System.out.println( "player removed :"+players.getEntry(i));
        players.remove(i);
       return i;
     }
